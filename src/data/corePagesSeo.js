...
export const CORE_PAGES = [
  ...
  },
  {
    ...
    description: "Dental practitioners: iSmile Dental Clinic in Damansara Jaya, PJ welcomes expressions of interest — an established family patient base, session-based arrangements and a supportive clinical team.",
    ...
    facts: [
      ...
      "Session-based arrangements shaped around your stage of practice, from locum sessions to a full-time association",
      "Share your details and CV through the form on this page — every enquiry is read personally and treated in confidence",
    ],
  },
];
