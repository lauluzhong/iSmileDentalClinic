export default {
  ...
  sections: [
    {
      heading: 'Replacing a missing tooth in Petaling Jaya',
      body: `Losing a tooth changes more than the look of a smile. Chewing shifts to the other side of the mouth, speech can change slightly, and the teeth on either side of the gap may drift into the space over time. The bone that once held the tooth root is no longer loaded the way it used to be, and it can gradually reduce in volume.
...
Each of these can be the right answer. Which one suits you depends on how many teeth are missing, where they are, the condition of the remaining teeth, the amount and quality of bone in the area, your general health, and how you would prefer to look after the result.`,
    ...
    {
      heading: 'How implant treatment usually works',
      body: `Implant treatment is a sequence of appointments spread over a period of months rather than a single procedure. The exact plan varies from person to person, and your dentist will set out the stages that apply to you before anything begins.
...
Fifth, the restoration. Once healing is judged complete, an abutment and a crown are fitted, and the bite is adjusted so the new tooth shares the load properly with the rest of the mouth.`,
    ...
    {
      heading: 'What makes an implant case straightforward, and what makes it complex',
      body: `This is what most people are really asking when they start looking into treatment, and it is worth understanding before the consultation.
...
Our team plans and treats a range of case complexity, from single tooth replacement through to more involved reconstruction, and treatment planning is led by experienced clinicians. Where a case would be better served by referral, we will say so.`,
    },
    {
      ...
      body: `Bone volume is the most common reason an implant plan turns out to be longer than a patient expected. When a tooth has been missing for years, the ridge of bone in that area may have narrowed or reduced in height, and there may not be enough for an implant to sit in the ideal position.
...
This is one of the clearest reasons a three dimensional scan matters at the planning stage. A standard dental X-ray shows the site in two dimensions and cannot reliably show the width of the bone. Knowing at the outset whether grafting is likely changes the plan and the number of appointments, and it is far better discussed at the beginning than discovered later.`,
    ...
    {
      heading: 'Crowns, bridges and dentures at our clinic',
      body: `Not every gap calls for an implant, and implants are not the only work we do in this area.
...
Where a full arch is missing, there are approaches that combine implants with a denture so that a removable prosthesis is held far more securely than it would be by fit alone. Whether that is appropriate depends on the bone available and on what you want from the result.`,
    ...
    {
      heading: 'What happens at a tooth replacement consultation',
      body: `The first appointment is about information, and you should expect to leave it understanding your options rather than committed to one.
...
We provide receipts and documentation for insurance claims. Patients pay for treatment first and then submit their claim to their insurer or company.`,
    },
    {
      ...
      body: `Tooth replacement is a considered decision, and asking the same questions at every clinic you visit is the most useful thing you can do.
...
Whichever route you take, the review appointments are part of the treatment rather than an optional extra, since problems around implants and restorations are usually easier to manage when picked up early.`,
  ...
  faqs: [
    {
      q: 'How long does dental implant treatment take from start to finish?',
      a: 'It is a staged treatment carried out over a period of months rather than a single visit, because the bone needs time to heal around the implant before the final crown is fitted. The number of stages depends on whether a tooth still needs removing, whether grafting is involved, and where in the mouth the implant sits. Your dentist will set out an expected sequence for your case at the planning appointment.',
    },
    {
      q: 'Is having an implant placed painful?',
      a: 'Placement is normally carried out under local anaesthetic, so the procedure itself should not be painful. Some soreness and swelling afterwards is common and is usually managed with ordinary pain relief. Your dentist will go through what to expect and what to do if anything feels unusual.',
    },
    {
      q: 'Am I too old for a dental implant?',
      a: 'Age on its own is rarely the deciding factor. What matters more is the health of the gums, the amount and quality of bone at the site, general health, and any medications that may affect healing. These are assessed at the consultation.',
    },
    {
      q: 'What if I have been told I do not have enough bone?',
      a: 'This is a common finding, particularly where a tooth has been missing for several years. Bone grafting can sometimes make a site suitable for an implant, either before placement or at the same time. A three dimensional scan is the usual way to establish how much bone is present and what the options are.',
    },
    {
      q: 'Should I choose an implant or a bridge?',
      a: 'It depends on the state of the teeth beside the gap. An implant leaves the neighbouring teeth untouched, while a bridge uses them as supports and involves reducing them. Where those neighbouring teeth already carry large fillings or crowns, a bridge may make more sense. Where they are healthy and intact, many patients prefer not to alter them.',
    },
    {
      q: 'Can implants be used to hold a loose denture in place?',
      a: 'In many cases yes. Implants can be used to retain a removable denture so that it is held more securely than by fit alone. Whether this is suitable depends on the bone available and what you want from the result, and your dentist will discuss it as one of the options for a full or partial arch.',
    },
    {
      q: 'Do you do the scan and planning in the clinic?',
      a: 'Yes. We use cone beam CT imaging, which produces a three dimensional view of the jaw so that bone volume and the position of nearby structures can be assessed properly before treatment is planned.',
    },
    {
      q: 'My denture has become loose. Does it need replacing?',
      a: 'Not necessarily. The ridge of bone under a denture changes shape slowly over the years, and a denture that fitted well when it was made can become loose as a result. A reline adjusts the fitting surface to the current shape of the ridge, which often restores comfort without making a new denture. We also carry out denture repairs.',
    },
    {
      q: 'Where is the clinic and how do I arrange an assessment?',
      a: 'We are in Damansara Jaya, Petaling Jaya, and we see patients from across PJ and the surrounding areas. Assessments can be arranged by phone or WhatsApp during clinic hours.',
    },
    {
      q: 'Can I claim tooth replacement treatment on insurance?',
      a: 'We provide receipts and documentation to support claims. Patients pay for treatment first and then submit the claim to their own insurer or company, and what is covered depends on the individual policy.',
    },
  ],
};
