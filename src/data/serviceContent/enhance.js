export default {
  ...
  sections: [
    {
      heading: 'Cosmetic dentistry in Petaling Jaya',
...
Good cosmetic work is not only about whiteness. Teeth have texture, translucency and slight irregularities, and a result that ignores those reads as artificial. Planning also has to account for the bite, because a restoration that looks correct but takes more load than it should is unlikely to last well.`,
    ...
    {
      heading: 'What each treatment can change',
      body: `Colour alone is usually a whitening question. Whitening lightens the natural tooth without removing tooth structure, which makes it the least invasive of the cosmetic options and often the first one to consider.
...
Sensitivity during a course of whitening is common and usually temporary. It can often be managed by changing the wear time or using a desensitising product, and your dentist will advise.`,
    ...
    {
      heading: 'Composite and ceramic veneers',
      body: `A veneer is a thin layer bonded to the front of a tooth to change its shape, colour or both. We provide both composite and ceramic veneers, and they suit different situations.
...
Veneers are not suitable for every tooth. Very little remaining enamel, active gum problems, untreated decay or heavy grinding may call for a different plan, and those factors are checked before anything is prepared.`,
    ...
    {
      heading: 'Crowns and full mouth rehabilitation',
      body: `Where a tooth is badly broken down, heavily filled or root treated, a crown covers and protects what remains rather than only resurfacing it. All ceramic crowns give a natural appearance without a metal substructure, and a single visit crown can be arranged by appointment.
...
It is planned in stages, with records, imaging and often a trial of the proposed shape before permanent work is carried out. The sequence and the number of appointments are set out at the planning stage rather than discovered along the way.`,
    ...
    {
      heading: 'Planning a smile makeover',
      body: `A smile makeover is not a single procedure. It is a plan that may combine whitening, veneers, crowns, gum work and sometimes tooth movement, arranged so that each step supports the next.
...
Photographs, scans and shade records are often taken so that the plan can be prepared properly, and an itemised treatment plan can be prepared in writing if you ask for one. We provide receipts and documentation for insurance claims, with patients paying for treatment first and then submitting the claim to their own insurer or company, though cosmetic treatment is frequently excluded from policies.`,
    },
    {
      ...
      body: `Ask how much tooth structure will be removed, and whether the treatment can be reversed if you change your mind.
...
Ask what the alternative plan would be, and why the recommended one was preferred for your mouth.`,
    ...
    {
      heading: 'Making cosmetic work last',
      body: `Cosmetic restorations are durable but not indestructible, and how long they serve depends heavily on the mouth they are placed in and how they are looked after.
...
Routine care is the same as for natural teeth: brushing, cleaning between the teeth, and regular check ups so that the margins of restorations and the gums around them can be reviewed.`,
  ...
  faqs: [
    {
      q: 'How white can my teeth realistically get?',
      a: 'That varies from person to person. The natural shade of the tooth, the type of discolouration and how it responds to the gel all affect the outcome. Surface staining from food, drink and smoking tends to respond well, while discolouration from within the tooth is less predictable. Your dentist will look at your teeth and give you a realistic expectation before starting.',
    },
    {
      q: 'Is take home or in clinic whitening better?',
    ...
    },
    {
      ...
      a: 'Professionally supervised whitening does not remove tooth structure. Temporary sensitivity during a course of treatment is common and usually settles. Supervision matters because the trays are made to fit your own gum line and the strength of the gel is prescribed rather than guessed.',
    },
    {
      q: 'Will whitening lighten my crowns and fillings?',
      a: 'No. Whitening only affects natural tooth structure. Existing crowns, veneers and fillings keep their original colour, so a visible restoration may no longer match after whitening and may need replacing to match the new shade. This is one reason whitening is usually done before new cosmetic work rather than after.',
    },
    {
      q: 'What is the difference between composite and ceramic veneers?',
      a: 'Composite veneers are built up directly on the tooth by the dentist, often in one visit, and usually need little or no tooth preparation. Ceramic veneers are made in a laboratory and bonded at a later appointment, hold their colour and finish better, and generally require a thin layer of enamel to be prepared. Composite is easier to adjust or repair; ceramic is more durable.',
    },
    {
      q: 'Do veneers require the teeth to be filed down?',
      a: 'It depends on the type. Composite veneers can often be placed with minimal or no preparation. Ceramic veneers usually require a thin layer of enamel to be removed so the veneer fits without looking bulky, and that step is not reversible. How much preparation your case involves is something to establish before treatment begins.',
    },
    {
    ...
    },
    {
      ...
      a: 'Where the plan involves changing the shape of several front teeth, a trial smile can be used. This is a mock up of the proposed result placed over the teeth so the length, shape and proportions can be reviewed before permanent work is carried out.',
    },
    {
      q: 'I only have one discoloured front tooth. What are my options?',
      a: 'A single dark tooth is a different problem from generally yellow teeth and often has a specific cause, such as an old restoration or a previous injury to that tooth. The options may include internal whitening for a root treated tooth, replacing an existing restoration, or a veneer or crown. An assessment, usually with an X-ray, is the way to establish which applies.',
    },
    {
      q: 'Do I have to whiten or restore everything at once?',
      a: 'No. Cosmetic treatment can be staged, and it is reasonable to start with the most conservative option and review. Some patients whiten first, live with the result, and only then decide whether they want to change the shape of anything.',
    },
  ],
};
