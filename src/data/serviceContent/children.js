export default {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Yes. Our team sees children of all ages as part of family practice. Appointments for very young children are kept short and are usually an introduction rather than treatment.",
    },
    {
      q: "Do baby teeth really need treatment if they will fall out anyway?",
      a: "In many cases, yes. Baby teeth hold space for the adult teeth behind them, and losing one early can allow the neighbouring teeth to drift, which may affect how the adult tooth comes through. They also matter for chewing and speech, and decay in a baby tooth can become painful or infected. The dentist will explain what was found and what happens if you choose to watch and wait instead.",
    },
    {
      q: "What are fissure sealants and does my child need them?",
      a: "Sealants are thin protective coatings placed into the grooves of the back chewing teeth, which are difficult to clean and are a common starting point for decay. Whether they are worth doing depends on how deep the grooves are, how well your child brushes and their decay history. The dentist will assess this at a check-up and advise.",
    },
    {
      q: "Is professional fluoride treatment safe for children?",
      a: "Professionally applied topical fluoride is used to strengthen enamel and make it more resistant to decay, at a concentration appropriate to the child's age. It is applied by the dentist in the clinic rather than left with you. If you have concerns about your child's total fluoride exposure, raise it at the appointment and the dentist will talk it through.",
    },
    {
      q: "At what age can a child start braces or teeth straightening?",
      a: "There is no single age. Some children are assessed and simply monitored while they grow. Others may benefit from early interceptive treatment with a removable or functional appliance while the jaws are still developing, and full braces or aligners come later. Options that may be considered include myofunctional appliances, expanders, Invisalign First for children with a mix of baby and adult teeth, and conventional braces. Your dentist will advise on timing after assessing your child's growth stage.",
    },
    {
      q: "My child breathes through their mouth and snores. Is that a dental issue?",
      a: "It can be relevant to dental development, because breathing patterns and oral posture can influence how the jaws and face grow. A dental assessment can screen for these patterns and describe what we are seeing, but the underlying cause may be a medical one. Where that looks likely, the dentist will explain what a referral to the appropriate doctor would be for, so you have something specific to take to them.",
    },
    {
      q: "What should I do if my child is scared of the dentist?",
      a: "Tell us before the appointment, especially if there has been a difficult experience elsewhere. At home, keep the description short and neutral and avoid words like pain, needle or drill. In the clinic, a first visit for an anxious child is often just a look and a ride in the chair, which usually makes the next one easier.",
    },
    {
      q: "How often should children have a check-up?",
      a: "Every six months is the common interval, but the dentist may suggest a shorter or longer gap depending on decay risk, how growth is progressing, and whether anything is being monitored. You will be told what interval is being recommended and why.",
    },
    {
      q: "Where is the clinic and can the whole family be seen on the same visit?",
      a: "We are in Damansara Jaya, Petaling Jaya. Children's appointments can usually be arranged alongside adult appointments so one trip covers more than one family member. Message or call the clinic and the front desk will arrange the slots together.",
    },
  ],
};
