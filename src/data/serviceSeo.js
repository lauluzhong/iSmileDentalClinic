...
export const SERVICE_SPECIALTIES = [
  ...
  },
  {
    ...
    faqs: [
      { q: "How long does the process take?", a: "Typically, the osseointegration healing phase takes several months before the final crown is placed. Your dentist will give you a more specific estimate based on your individual case and bone quality." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "How long do veneers last?", a: "With proper care, ceramic veneers can last 10-15 years or longer. Composite veneers typically last 5-7 years before requiring maintenance or replacement." },
  ...
  },
  {
    ...
    faqs: [
      { q: "When should my child have their first dental visit?", a: "We typically recommend around age 1, or within 6 months of the first tooth appearing. Early visits help your child become comfortable with the dental environment and allow us to monitor growth and development from the start." },
