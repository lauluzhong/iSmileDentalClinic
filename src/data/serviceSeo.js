...
export const SERVICE_SPECIALTIES = [
  ...
  },
  {
    ...
    faqs: [
      { q: "When should my child have their first dental visit?", a: "We typically recommend around age two, when there are enough teeth to examine properly and most children can cooperate with the visit. If something is worrying you earlier, bring them in at any age. Early visits help your child become comfortable with the dental environment and allow us to monitor growth and development from the start." },
