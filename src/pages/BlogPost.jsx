...
const BlogPost = () => {
    ...
    return <div className="blog-post-page">
        ...
        <main className="container blog-article"><FadeIn>
            ...
            <section className="post-closing"><p className="eyebrow">Thoughtful care</p><p className="statement">Your Smile Deserves <em>Thoughtful Care</em></p><p>Schedule a consultation for a personalized assessment.</p><Button variant="primary" onClick={bookingAction}>Book a Consultation</Button></section>
        </FadeIn></main>
